...
<div id="main-content" class="container-fluid">
  ...
  <div class="card m-5">
    <div class="card-body">
      ...
      <p class="card-text">Divisi yang memproduksi serial tv seperti See It, Backbeat, We Style,dan Selepas Sendu.</p>
  ...
  <div class="card m-5">
    <div class="card-body">
      ...
      <p class="card-text">Divisi yang menyajikan berita-berita seputar kegiatan di UMN maupun di sekitarnya.</p>
      <!-- <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p> -->
  ...
  <div class="card m-5">
    <div class="card-body">
      <h5 class="card-title">IT & Web</h5>
      <p class="card-text">Divisi yang mengupdate Website dan membantu dalam program yang digunakan oleh Crew Program dan News.</p>
      <!-- <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p> -->
