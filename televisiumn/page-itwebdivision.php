...
<div id="main-content" class="container-fluid">
                    ...
                    <div id="headline" class="row justify-content-center align-items-center">
                        <div class="col-12">
                            ...
                            <div class="col-12 col-md-6 px-0">
                                <p>
                                    Terdiri dari 6 orang yang mengurus Website UMN TV dan juga membantu kelancaran produksi di bidang IT.</p>
                            </div>
  ...
  <div class="card m-5">
    <div class="card-body">
      ...
      <p class="card-text">Menjaga kelancaran produksi dalam hal software yang digunakan oleh Crew Program dan News.</p>
  ...
  <div class="card m-5">
    <div class="card-body">
      ...
      <p class="card-text">Mengupdate Website UMN TV agar dapat digunakan kala live streaming. </p>
      <!-- <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p> -->
      <!-- <a href="wordpress/progdivision" class="btn btn-primary">Crew Program</a> -->
    </div>
  </div>    
