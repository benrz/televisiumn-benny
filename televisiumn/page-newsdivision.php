...
<div id="main-content" class="container-fluid">
            ...
            <div class="carousel-item active">
                <div class="container">
                    <div id="headline" class="row justify-content-center align-items-center">
                        <div class="col-12">
                            <h4>Welcome to UMN TV News Division Official Website.</h4>
                            <div class="col-12 col-md-6 px-0">
                                <p>
                                    Terdiri dari 54 orang yang menggali informasi untuk pemirsa saksikan!</p>
                            </div>
  ...
  <div class="card m-5">
    <div class="card-body">
      <h5 class="card-title">Meja Redaksi</h5>
      <p class="card-text">Program berita satu-satunyanya di UMN TV, yang kini dikemas secara santai dan terpercaya. Tak ketinggalan dengan segmen kulik-kulik yang akan membahas seputar Industri Kreatif Anak Muda, yang nantinya ditemani oleh reporter cantik dan asyik</p>
